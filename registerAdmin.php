...
<?php 
	...
	if (empty($errors)) {
		...
		$query = "INSERT INTO users ( email, password, type ) VALUES ('{$email}', '{$hashed_password}', '{$userType}')";


		$result = mysqli_query($connection, $query);

		if ($result) {
			header('Location: login.php?admin_registration_successful');
		}
		else{
				  	...
				  	<div class="text-center">
				  		...
				  		<form  action="registerAdmin.php" method="POST">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <input type="submit" id="submit" name="submit" value="Register" class="btn btn-primary"></input>
